...
# Subtidal$Number <- NA
# Subtidal[Subtidal$Year == c("2018") & Subtidal$MonthNr == c("4"), "Number" ] <- 1
# Subtidal[Subtidal$Year == c("2018") & Subtidal$MonthNr == c("5"), "Number" ] <- 2
# Subtidal[Subtidal$Year == c("2018") & Subtidal$MonthNr == c("8"), "Number" ] <- 3
# Subtidal[Subtidal$Year == c("2018") & Subtidal$MonthNr == c("9"), "Number" ] <- 4
# Subtidal[Subtidal$Year == c("2018") & Subtidal$MonthNr == c("10"), "Number" ] <- 5
# Subtidal[Subtidal$Year == c("2018") & Subtidal$MonthNr == c("12"), "Number" ] <- 6
```
